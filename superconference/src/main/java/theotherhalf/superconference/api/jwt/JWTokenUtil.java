...
public class JWTokenUtil implements Serializable
{
    ...
    //@Value("${jwt.secret}")
    private final String secret = "brejica";
    ...
    {
        return doGenerateToken(userDetails.getUsername(), email);
    }
    ...
    private String doGenerateToken(String subject, String email)
    {
        return Jwts.builder().setSubject(subject).claim("email", email).setIssuedAt(new Date())
